...
import Card from '../Modal/CardAdminVolunteer_NoAction'
import Img from '../Asset/event2.jpg'
import Navbar from '../Components/NavbarAdmin'

const AdminVolunteerPendaftarDetail = () => {
        ...
        <div className="py-8 px-10 md:py-10 md:px-16 sm:flex gap-10">
          ...
          <div className="md:w-3/4">
            ...
            <div className="flex justify-between w-full">
              ...
              {/* Tambah Event */}
              <div className="bg-gra1b rounded-xl text-white font-semibold px-4 py-2 cursor-pointer hover:bg-gra1a" onClick={() => navigate("/admin/daftarkan-volunteer")}>
            ...
            <div className="bg-white rounded-b-2xl drop-shadow-xl px-6 py-10 w-full">
              <div className="flex gap-10">
                <div className="sm:w-1/4">
                  <Card img={Img} month="Jun" date="20" title="Bedah Buku" artist="Maudy Ayunda" place="Perpusnas" price="0" terjual="30" sisa="2" button="" onClick=""/>
                </div>

                <div className="sm:w-3/4">
                  <h1 className="font-semibold text-2xl text-primary underline underline-offset-8 decoration-secondary">Rekap Pendaftar</h1>
                  <br />
                  
                  <div className="md:flex justify-between rounded-xl border-2 px-10 py-6">
                    <div className="text-black w-2/4">
                      <h1 className="font-semibold">Pendaftaran Kegiatan Tiket</h1>
                      <br />
                      <table className="w-full">
                        <tbody>
                          <td className="">Terdaftar</td>
                          <td className="">: 30</td>
                        </tbody>
                        <tbody>
              ...
              <div>
                <h1 className="font-semibold text-2xl text-primary underline underline-offset-8 decoration-secondary">Data Pendaftar</h1>
                <br />
                ...
                <table className="table-auto text-center text-primary w-full text-sm">
                  ...
                  <tbody className="mb-2 bg-red-100">
...
export default AdminVolunteerPendaftarDetail