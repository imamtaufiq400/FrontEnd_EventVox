...
import Card from '../Modal/CardAdminEvent'
        ...
        <div className="py-8 px-10 md:py-10 md:px-16 sm:flex gap-10">
          ...
          <div className="md:w-3/4">
            ...
            <div className="bg-white rounded-b-2xl drop-shadow-xl px-6 py-10 w-full grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3">
              <Card img={Img} month="Jun" date="20" title="Bedah Buku" artist="Maudy Ayunda" place="Perpusnas" price="100 K" terjual="100" sisa="50" button="Detail" onClick={() => navigate("/admin/event/pembelian/detail")}/>
            </div>
          </div>
        </div>
      </div>
