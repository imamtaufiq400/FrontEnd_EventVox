      ...
      <div>
        ...
        <div className="py-8 px-10 md:py-10 md:px-16 sm:flex gap-10">
          ...
          <div className="md:w-1/4">
            ...
            <div className="border-2 border-secondary rounded-lg py-4 px-6 flex gap-4 hover:bg-secondary cursor-pointer" onClick={() => navigate("/admin/event/pembelian")}>
          ...
          <div className="md:w-3/4">
            ...
            <div className="flex justify-between w-full">
              ...
              {/* Tambah Event */}
              <Button onClick={() => navigate("/admin/daftarkan-event")}>+ Tambah Event</Button>
            </div>
