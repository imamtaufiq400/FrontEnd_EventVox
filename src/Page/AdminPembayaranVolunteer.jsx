          ...
          <div className="md:px-44 px-22">
            ...
            <div className="pb-4 bg-white drop-shadow-xl rounded-xl my-4">
              ...
              <div className="px-6 py-4 flex justify-between">
                <h2 className="font-medium text-lg text-black">Mulai Hari ini</h2>
                <h2 className="font-medium text-lg text-black">Sekali Bayar Sebesar Rp. 25.000</h2>
              </div>
                ...
                {/* <div> */}
                  <div className="flex gap-8 mb-4">
                    ...
                    <div>
                      ...
                      <div className="py-2 px-4 border-2 rounded-xl w-full">4628320901293735390</div>
                    </div>
                  </div>
