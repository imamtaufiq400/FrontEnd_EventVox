  ...
  return (
    <div className="card w-full bg-base-100 shadow-xl z-0">
      <figure className="relative">
        ...
        <div className="px-4 py-2 bg-blue-950 absolute bottom-0 left-0">
      ...
      <div className="flex justify-center p-6 gap-5">
        ...
        <div className="flex flex-col items-start text-primary w-1/4">
          ...
          {/* <span className="w-full h-8 container bg-red-700 text-white text-center mt-4 p-1">
            {props.price}
          </span> */}
        </div>
      ...
      <div className="card-actions space-x-2 justify-end pb-6 px-6">
        <Button onClick={props.onClick} className="badge badge-outline">{props.button}</Button>
      </div>
    </div>
  )
}
